                ...
                <div class="panel-body">
                    <div class="bootstrap-iso">
                        <div class="container-fluid">
                             <?php echo form_open_multipart('iteminst/saveitemdata');?>
<!--                            <form class="" name="item_insert" id="item_insert" method="post" action="<?php //echo base_url(); ?>iteminst/saveitemdata">-->
                                <div class="row">
                                    ...
                                    <div class="col-sm-3" >
                                        <div class="form-group ">
                                            ...
                                            <input type="number" class="form-control" name='price_name' id="price_name" placeholder="Enter price" maxlength="10">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeA odd" role="row">
                                            ...
                                            <td class="edit tooltip-display" style="background-color:">
                                                 ...
                                                 <a href="<?php  echo base_url(); ?>iteminst/edit/<?php echo $value['id']; ?>">
                                                ...
                                                <span data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Close Location">
                                                    <a href="<?php echo base_url();?>iteminst/delete/<?php echo $value['id']; ?>">
  ...
  $(document).ready(function () {
        ...
        //alert($.trim($(this).val()).length);
                    if($.trim($(this).val()).length > 0){
                       ...
                       $.ajax({
                                type: 'POST',
                                url: '<?php echo base_url(); ?>iteminst/ajaxcheckitem',
    ...
    $("form").submit(function(){
        ...
        if($.trim($.trim($("#itemalerthidden").val())=="" || $.trim($("#itemalerthidden").val())=='0' || $("#item_name").val())=="")
        {
             $("#item_name").parent().addClass('has-error');
             $('#alertmsg1').html('');
             $('#alertmsg1').append("Item name should not be blank!");
