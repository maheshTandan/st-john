...
<div id="page-wrapper" style="min-height: 327px;">
 ...
 <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header" style="text-align:center">Milk Only Report Calendar</h1>
        </div>
 </div>

 <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>BmTeacherReportController/monthlyOrderReportMilkOnly">
  ...
  <div class="row" align="center">
                          ...
                          <div class="col-md-12 searchbarMargin">
                                ...
                                <div class="col-sm-4">
                                   ...
                                   <div class="input-group date" data-provide="datepicker" id="datepicker" data-date="2018-02" data-date-format="yyyy-mm">
