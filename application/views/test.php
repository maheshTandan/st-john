...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link type="text/css" href="<?php echo base_url('application/css/bootstrap.min.css'); ?>" rel="stylesheet">

    <!-- MetisMenu CSS -->
    <link type="text/css" href="<?php echo base_url('application/css/metisMenu.min.css'); ?>" rel="stylesheet">

    <!-- Custom CSS -->
    <link type="text/css" href="<?php echo base_url('application/css/sb-admin-2.css'); ?>" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link type="text/css" href="<?php echo base_url('application/css/morris.css'); ?>" rel="stylesheet">

    <!-- Custom Fonts -->
    <link type="text/css" href="<?php echo base_url('application/css/font-awesome.min.css'); ?>" rel="stylesheet" >
